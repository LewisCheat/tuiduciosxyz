...
const apps = [
    {
        name: 'AOV CHEAT VN',
        url: 'https://zufile.com/download/O7u0UiG4on',
        ...
        descriptions: 'Hack Map Chống Tố Vip Mua Key LH thông tin phía trên | Cập Nhật Ngày 25/10'
    },
    {
        name: 'AOV LITE',
        ...
        img: 'https://is1-ssl.mzstatic.com/image/thumb/Purple211/v4/fd/70/b9/fd70b970-f007-632e-f97d-30afc419f954/AppIcon-1x_U007emarketing-0-11-0-85-220-0.png/512x512bb.jpg',
        icon: 'https://is1-ssl.mzstatic.com/image/thumb/Purple211/v4/fd/70/b9/fd70b970-f007-632e-f97d-30afc419f954/AppIcon-1x_U007emarketing-0-11-0-85-220-0.png/512x512bb.jpg',
        descriptions: 'Hack Map Kín Full Chức Năng Vip Vượt Link Mỗi 24h Để Lấy Key | Cập Nhật Ngày 25/10'
    },
    {
        name: 'Key AOV LITE',
        url: 'https://v4.ppapikey.xyz/getlink?tokenID=135&username=1711Cheat',
        img: 'https://cdn-icons-gif.flaticon.com/11259/11259476.gif',
        descriptions: 'Mỗi 24h AE có thể vào link này lấy key để chơi bản AOV LITE'
    },
    {
        name: 'Map Đài Antiban Vip',
        url: 'https://linkday.xyz/g0BxFHgtrm',
        img: 'https://is1-ssl.mzstatic.com/image/thumb/Purple211/v4/fd/70/b9/fd70b970-f007-632e-f97d-30afc419f954/AppIcon-1x_U007emarketing-0-11-0-85-220-0.png/512x512bb.jpg',
        icon: 'https://is1-ssl.mzstatic.com/image/thumb/Purple211/v4/fd/70/b9/fd70b970-f007-632e-f97d-30afc419f954/AppIcon-1x_U007emarketing-0-11-0-85-220-0.png/512x512bb.jpg',
        descriptions: 'Hack Map Server Đài Kín No Key | Cập Nhật Ngày 22/10'
    },
    {
...
// Render
renderItems(apps, 'downloadAppContainer', 'App Icon');

function renderItems(data, containerId, iconAlt, iconSize = { w: 60, h: 60 }) {
    const container = document.getElementById(containerId);
    const fragment = document.createDocumentFragment();
    data.forEach(({ icon, title, description = '', link, iconTitle }) => {
        const item = document.createElement('div');
        item.className = 'app-item';
        item.innerHTML = `
            <div class="info">
                <img src="${icon}" alt="${iconAlt}" width="${iconSize.w}" height="${iconSize.h}">
                <div class="text">
                    <span class="title">${title}</span>
                    ${description ? `<span class="description">${description}</span>` : '<span class="auto-time"></span>'}
                </div>
            </div>
            <a href="${link}" class="download-button" title="${iconTitle || 'Tải về'}" target="_blank">
                <i class="fas ${iconTitle?.toLowerCase().includes('key') ? 'fa-up-right-from-square' : 'fa-download'}"></i>
            </a>
        `;
